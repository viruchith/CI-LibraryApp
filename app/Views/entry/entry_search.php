...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="overflow-auto col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column mb-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/entry/search">
                                <span data-feather="search"></span>
                                Search 
                            </a>
                        </li>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container">
                    <div class="container">
                        <form id="entry-search" action="/entry/search" method="post">
                            <div class="form-group">
                                <input type="search" class="form-control" name="s" id="s" aria-describedby="helpId" placeholder="Search" required>
                            </div>
                            <br>
                            <div class="form-group">
                                <select class="form-control" name="m" id="m">
                                    ...
                                    <option value="member_mobile">Member Mobile</option>
                                    <option value="batch">Batch</option>
                                </select>
                            </div>
                            <br>
                            <button type="submit" class="btn btn-primary">Find &nbsp;<i data-feather="search"></i> </button>
                        </form>
    ...
    <script>
        ...
        $("#entry-search").submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success == true) {
                        ...
                        $("#tbody").html("");
                        $("#result-box").html("<h4 class='error' > " + data.msg + " </h4>")
                    }
                }
            });
        });
