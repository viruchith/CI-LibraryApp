            ...
            <nav id="sidebarMenu" class="overflow-auto col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column mb-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/book/return">
                ...
                <div class="container">
                    <div class="container">
                        <div id="search-cont" class="container">
                            ...
                            <form action="/book/return" method="get">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <button type="submit" class="btn btn-primary"><i data-feather="book-open"></i></button>
                                </div>
                            </form>
                        </div>
                        <br>
                        ...
                        ?>
                            ...
                            <br>
                            <form action="/book/return" method="post" class="container">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="pin" id="pin" aria-describedby="helpId" pattern="[0-9]{4}" required>
