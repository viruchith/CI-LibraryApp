...
<body>
        ...
        <div class="row">
            <nav id="sidebarMenu" class="overflow-auto col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column mb-2">
                        <li class="nav-item">
                            <a class="nav-link active" href="/book">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="d-flex justify-content-center">
                    <h3 class="display-6" id="book-total-count" data-count="<?= $books_count ?>"></h3>
                </div>
                <div class="container">
                    <div class="d-flex">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="editor-title" class="modal-title">Edit Book</h5>
    ...
    <script type="module">
        ...
        function bookCounter(){
            ...
            var total_books = $("#book-total-count").attr("data-count");

            let demo = new CountUp('book-total-count', total_books, options);
            if (!demo.error) {
                demo.start();
            } else {
