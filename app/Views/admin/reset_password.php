...
<body>
    ...
    <div class="login-clean">
        <form id="admin-reset" method="POST" action="/admin/resetpassword?q=<?= $q ?>&a=<?= $a ?>" style="background: rgb(255,255,255);" onsubmit="return validateForm()">
            <h2 class="sr-only">Reset Password</h2>
            <div id="alert-container"></div>
            <div class="illustration"><i class="icon ion-android-lock" style="color: rgb(0,0,0);"></i></div>
            <div class="form-group">
                <input id="password" class="border-primary shadow form-control rubberBand animated" type="password" data-toggle="tooltip" data-bs-tooltip="" name="password" placeholder="New Password" required title="Your New Password">
            </div>
            <div class="form-group">
